...
class Generator extends \yii\gii\Generator
{
    ...
    public function generateActiveField($attribute)
    {
        ...
        //added for date field
         elseif ($column->type === 'date') {
             return " ''?>
<div class='form-group field-continent-co_created_on required'>
    <?= Html::activeLabel(\$model, 'co_created_on', ['class' => 'control-label']) ?>
    <?php
    
    echo DatePicker::widget([
        'model' => \$model,
        'attribute' => 'co_created_on',
        'id' => 'continent-co_created_on',
